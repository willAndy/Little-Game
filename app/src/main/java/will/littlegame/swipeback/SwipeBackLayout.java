...
public class SwipeBackLayout extends FrameLayout {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        Log.i(TAG, "cgg mViewPager = " + mViewPager);
        ...
        switch (ev.getAction()) {
            case MotionEvent.ACTION_DOWN:
                downX = tempX = (int) ev.getRawX(); // 触摸点相对于屏幕的坐标
    ...
    public void computeScroll() {
        ...
        if (mScroller.computeScrollOffset()) {
            ...
            postInvalidate();
            // Log.e(Config.TAG, "mScroller." + mScroller.isFinished());
            // Log.e(Config.TAG, "isFinish ." + isFinish);
